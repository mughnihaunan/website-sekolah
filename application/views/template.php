...
<head>
  ...
  <title>SD Islam Khazanah Kebajikan</title>
        ...
        <ul class="nav navbar-nav navbar-right">
          <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
              aria-expanded="false">Riwayat <span class="caret"></span></a>
          ...
          <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
              aria-expanded="false">Guru & Karyawan <span class="caret"></span></a>
            <ul class="dropdown-menu">
          ...
          <li class="nav-login">
            <?= anchor('auth/login', '<span class="glyphicon glyphicon-user"></span> Login', ['class' => 'btn btn-login']); ?>
          </li>
        </ul>
      </div><!--/.nav-collapse -->
    </div>
  ...
  <footer class="footer">
    <div class="container">
      ...
      <div class="col-md-2 col-md-offset-7">
        ...
        <p class="text-muted right">&copy; Copyright 2026 SD Islam Khazanah Kebajikan</p>
      </div>
    </div>
    </div>
  </footer>
