<div class="col-md-6 col-md-offset-3 nopadding-all marginTop60px">
	...
	<?= $errors['name'] ?? ''; ?>
	<input type="text" class="form-control" name="name" value="<?= $old_value['name'] ?? ''; ?>" placeholder="Nama file">
	<?= $errors['url'] ?? ''; ?>
	<input type="text" class="form-control" name="url" value="<?= $old_value['url'] ?? ''; ?>"
	...
	<button type="submit" name="submit" class="btn btn-success"><span class="glyphicon glyphicon-save"></span>
		Simpan</button>
	<a href="<?= base_url('adminDownloadFile'); ?>" class="btn btn-danger"><span
