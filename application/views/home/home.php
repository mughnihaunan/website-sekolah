<div class="jumbotron openingWord cf lazy-bg" style="background-image: url('<?= $openingWord['url_background']; ?>');">
	<div class="container">
	...
	<div class="col-md-7 galeriHome">
		<a href="<?= base_url('galeri/foto'); ?>">
			<?php if ($foto ?? ''):
				...
				foreach ($foto as $f): ?>
					<div
						class="col-md-<?php if ($no == 1) {
							echo "5 fotoImage-green";
						} else if ($no == 2) {
							echo "7 fotoImage-blue";
						} else {
							echo "12 fotoImage-orange";
						} ?>">
			...
			<?php if ($berita):
				...
				<div class=" col-md-12 keterangan">
						<?php else: ?>
							...
							<a href="<?= base_url('home/beritaDetail/' . $b->berita_id); ?>">Selengkapnya <span
